...
fn test_matrix_product() {
    ...
    let matrix_v = SimpleZ2Matrix::new_all_one(vec![
        vec![0],
        vec![1],
        vec![2],
        vec![3],
...
fn test_matrix_bhcol_interface() {
    let base_matrix = SimpleZ2Matrix::new_all_one(vec![
        vec![],
        vec![],
        vec![],
        vec![0, 1],
...
#[test]
fn test_consolidate() {
    let mat = SimpleZ2Matrix::new_all_one(vec![vec![0], vec![0, 1]]);
...
fn test_projection() {
    ...
    let projection_matrix = SimpleZ2Matrix::new_all_one(projection_cols);

    let projected = product(&projection_matrix, &base_matrix);

    let true_matrix = SimpleZ2Matrix::new_all_one(vec![vec![4], vec![4], vec![], vec![]]);
...
fn test_basis_reverse() {
    ...
    let unrev_matrix = <(&rev_matrix) as &ReverseMatrix<_>>.unreverse();
